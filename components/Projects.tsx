  ...
  const projects = [
    {
      ...
      desc: "Built using Flask, OpenAI API, Pandas, NLTK, and Scikit-learn to provide natural language responses, supported by ML/NLP tools for data-driven query handling. .",
    ...
    },
    {
      ...
      tech: ["Flask", "Random Forest", "NLP", "Pandas"],
    },
    {
